...
export default function PeopleTuring() {
  return (
    <div className="bg-[#fafafa] pt-10 ">
      <div className="flex sm:flex-col sm:pl-5 md:flex-col md:pl-10 lg:flex-row lg:justify-around md:justify-around lg:gap-80 md:gap-30 ">
        <div className="">
          <p className="text-[24px] font-semibold">People ❤️ Turing</p>
          <p className=" lg:w-[54%] md:w-[80%] pt-4 leading-6 text-[17px]">
            Read Turing.com reviews from developers across the world and
            learn what it’s like working with top U.S. companies.
          </p>
        </div>
        <div className="text-end sm:text-left md:text-start lg:text-end md:pr-6">
          <div className="flex justify-end sm:justify-start md:justify-start">
            <p className="font-[500] text-[28px] ">⭐ 4.7</p>
            <p className="pt-5 pl-3 text-[12px] text-[gray]">OUT OF 5</p>
          </div>
          <p className="text-[#AAAAAA] pt-2 text-[14px]">
