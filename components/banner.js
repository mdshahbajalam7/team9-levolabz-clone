      ...
      <div className=" lg:w-[80%]  mx-[auto] flex  sm:flex-col-reverse md:flex-col-reverse lg:flex-row sm:pb-7">
        <div className="lg:pl-3  sm:pl-5 pt-6 ">
          ...
          <div className="pt-6 flex sm:flex-col sm:gap-3 md:flex-col md:gap-3 lg:flex-row lg:gap-1">
            <button onClick={onClicks} className="px-10 py-3 bg-[#e76a44] border rounded-md text-white font-semibold mr-3 hover:bg-slate-200 hover:text-black hover:border border-[#ea8060]">
              See Our Projects
            </button>
            
            <button onClick={onclick} className=" bg-[#e76a44] px-14 py-3 mr-3 border rounded-md text-white font-semibold  hover:bg-slate-200 hover:text-black hover:border border-[#ea8060]">
              Get In Touch
            </button>
          </div>
        </div>
